...
if($res->num_rows > 0){
 ...
 echo "<div style='margin-bottom: 20px;padding: 20px;background-color: white;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);> User: ". $row["user"]. "<br/> Title: ". $row["posttitle"]. "<br/> Content: ". $row["content"]. "<br/>  </div>";
$rownum=$row["id"];
echo $rownum;
